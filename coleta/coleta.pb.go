...
const (
	...
	Metadados_AMIGAVEL_PARA_RASPAGEM      Metadados_FormaDeAcesso = 1 // Aqui temos URLs determinísticas, tags usadas com semântica bem-definida - deprecated
	Metadados_RASPAGEM_DIFICULTADA        Metadados_FormaDeAcesso = 2 // Aqui temos URLs determinísticas, tags usadas com semântica bem-definida e é possível fazer raspagem dos dados
...
type Coleta struct {
	...
	RepositorioParser  string               `protobuf:"bytes,10,opt,name=repositorio_parser,json=repositorioParser,proto3" json:"repositorio_parser,omitempty"`
	VersaoParser       string               `protobuf:"bytes,11,opt,name=versao_parser,json=versaoParser,proto3" json:"versao_parser,omitempty"`
}
...
func (x *Coleta) GetRepositorioParser() string {
	if x != nil {
		return x.RepositorioParser
	}
	return ""
}

func (x *Coleta) GetVersaoParser() string {
	if x != nil {
		return x.VersaoParser
	}
	return ""
}
...
type Metadados struct {
	...
	NaoRequerLogin      bool                         `protobuf:"varint,1,opt,name=nao_requer_login,json=naoRequerLogin,proto3" json:"nao_requer_login,omitempty"`                                  // É necessário login para coleta dos dados? - deprecated
	NaoRequerCaptcha    bool                         `protobuf:"varint,2,opt,name=nao_requer_captcha,json=naoRequerCaptcha,proto3" json:"nao_requer_captcha,omitempty"`                            // É necessário captcha para coleta dos dados? - deprecated
	...
	FormatoAberto       bool                         `protobuf:"varint,16,opt,name=formato_aberto,json=formatoAberto,proto3" json:"formato_aberto,omitempty"`                                      // Órgão disponibiliza dados em formato aberto?
}
...
func (x *Metadados) GetFormatoAberto() bool {
	if x != nil {
		return x.FormatoAberto
	}
	return false
}
...
var file_coleta_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x65, 0x6e, 0x76, 0x22, 0x95, 0x03, 0x0a, 0x06, 0x43, 0x6f, 0x6c, 0x65, 0x74, 0x61,
	...
	,
	...
	0x45, 0x54, 0x41, 0x4c, 0x48, 0x41, 0x44, 0x4f, 0x10, 0x02, 0x42, 0x24, 0x5a, 0x22, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x61, 0x64, 0x6f, 0x73, 0x6a, 0x75,
	0x73, 0x62, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6f, 0x6c, 0x65, 0x74, 0x61,
