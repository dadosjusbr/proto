...
_METADADOS_FORMADEACESSO = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NECESSITA_RASPAGEM', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NECESSITA_SIMULACAO_USUARIO', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_METADADOS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='acesso', full_name='Metadados.acesso', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='extensao', full_name='Metadados.extensao', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='estritamente_tabular', full_name='Metadados.estritamente_tabular', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='formato_consistente', full_name='Metadados.formato_consistente', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tem_matricula', full_name='Metadados.tem_matricula', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tem_lotacao', full_name='Metadados.tem_lotacao', index=5,
      number=8, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tem_cargo', full_name='Metadados.tem_cargo', index=6,
