...
_RESULTADOEMPACOTAMENTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='backup', full_name='ResultadoEmpacotamento.backup', index=2,
